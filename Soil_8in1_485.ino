...
#define SERVER_IP "192.168.50.201:5670"

#ifndef STASSID
#define STASSID "Idatabots"
#define STAPSK  "Rkl3548123#"
#endif
#define RE 0
#define DE 2
...
void loop() {
  ...
  Serial.println();
  int httpCode = http.POST("{\"Multi_parameters_soil_sensors_1\":\"{'Temperature':"+String(TEMPERATURE, 1)+","+"'Moisture\':"+String(MOISTURE,1)+","+"'Electrical_conductivity\':"+String(EC,1)+","+"'PH\':"+String(PH,1)+","+"'Nitrogen\':"+String(N,0)+","+"'Phosphorus\':"+String(P,0)+","+"'Potessium\':"+String(K,0)+","+"'Salinity\':"+String(SALINITY,0)+"}\"}");
